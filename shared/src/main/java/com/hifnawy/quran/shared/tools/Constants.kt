...
object Constants {
    ...
    enum class Actions {
        PLAY_MEDIA, PAUSE_MEDIA, TOGGLE_MEDIA, STOP_MEDIA, SKIP_TO_NEXT_MEDIA, SKIP_TO_PREVIOUS_MEDIA,
        SEEK_MEDIA
    }

    enum class IntentDataKeys {
        RECITER, CHAPTER, CHAPTER_URL, CHAPTER_DURATION, CHAPTER_POSITION, IS_MEDIA_PLAYING,
        SINGLE_DOWNLOAD_TYPE
    }
}